...
**NOTE: TO BE MIGRATED TO https://github.com/lasthyphen/dijetsnode-go-runner.**

# `network-runner` RPC server

**What does `network-runner` do?** The primary focus of [`network-runner`](https://github.com/lasthyphen/dijetsnode-go-runner) is to create a local network, as a test framework for local development.
...
```bash
# to install
cd ${HOME}/go/src/github.com/lasthyphen/djtx-tester
...
curl -X POST -k http://localhost:8081/v1/control/start -d '{"execPath":"/Users/gyuho.lee/go/src/github.com/lasthyphen/dijetsnodego/build/avalanchego","whitelistedSubnets":"24tZhrm8j8GCJRE9PomW8FaeqbgGS4UAQjJnqqn8pq5NwYSYV1","logLevel":"INFO"}'

# or
avalanche-network-runner control start \
--log-level debug \
--endpoint="0.0.0.0:8080" \
--avalanchego-path ${HOME}/go/src/github.com/lasthyphen/dijetsnodego/build/avalanchego \
